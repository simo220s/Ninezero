...
export default function SignupPage() {
  ...
  const getErrorMessage = (error: any): string => {
    ...
    if (message.includes('already registered') || 
      ...
      return 'البريد الإلكتروني مستخدم بالفعل. يرجى تسجيل الدخول أو استخدام بريد آخر'
    }
    
    // Invalid email format
    if (message.includes('Invalid email') || 
        message.includes('invalid_email')) {
      return 'البريد الإلكتروني غير صحيح. يرجى التحقق من الصيغة'
    }
    ...
    if (message.includes('Password') && 
      ...
      return 'كلمة المرور ضعيفة. يرجى استخدام أحرف وأرقام ورموز'
    }
  ...
  return (
    <>
      <div className="min-h-screen bg-bg-light flex items-center justify-center py-12 px-4" dir="rtl">
