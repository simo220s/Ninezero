  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="تعرف على الأستاذ أحمد، معلم اللغة الإنجليزية المعتمد من جامعة أريزونا مع أكثر من 8 سنوات من الخبرة" />
      </Helmet>
            ...
            <div className="max-w-4xl mx-auto px-4">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-text-secondary arabic-text leading-relaxed mb-4">
                  السلام عليكم! أنا الأستاذ أحمد، معلم إنجليزي معتمد من جامعة أريزونا بشهادة TESOL. 
                  عندي شغف كبير بتعليم الإنجليزي ومساعدة الطلاب يحققون أهدافهم.
                </p>
                <p className="text-text-secondary arabic-text leading-relaxed mb-4">
                  على مدار أكثر من 8 سنوات، ساعدت أكثر من 500 طالب يطورون مهاراتهم بالإنجليزي، 
                  سواء للدراسة، الشغل، أو السفر. أؤمن إن كل طالب مختلف ويحتاج منهج مخصص 
                  يناسب احتياجاته وأهدافه.
                </p>
                <p className="text-text-secondary arabic-text leading-relaxed">
                  استخدم أحدث الطرق التعليمية التفاعلية اللي تخلي تعلم الإنجليزي ممتع وفعال. 
                  هدفي إني أساعدك تتكلم بثقة وطلاقة في أي موقف.
                </p>
              </div>
            </div>
          </section>
                ...
                <div className="bg-white rounded-xl p-6 shadow-custom-md">
                  <div className="flex items-start space-x-4 space-x-reverse">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-text-secondary arabic-text">
                        أكثر من 500 طالب متفوق في اللغة الإنجليزية
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto px-4">
              <div className="bg-gradient-to-br from-primary-600 to-primary-700 rounded-2xl p-8 md:p-12 text-center shadow-2xl">
                <h2 className="text-3xl md:text-4xl font-bold text-white arabic-text mb-4">
                  ولدك خايف يتكلم انجليزي؟
                </h2>
                <p className="text-xl text-white text-opacity-90 arabic-text mb-8">
                  احجز الحصة التجريبية المجانية الحين وخله يكسر حاجز الخوف
                </p>
