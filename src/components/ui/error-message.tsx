 ...
 */
export const InlineError = ({ message, className = '' }: ErrorMessageProps): JSX.Element => {
  return (
 ...
 */
export const ErrorCard = ({ message, onRetry, className = '' }: ErrorMessageProps): JSX.Element => {
  return (
 ...
 */
export const ErrorPage = ({ message, onRetry }: ErrorMessageProps): JSX.Element => {
  return (
 ...
 */
export const NetworkError = ({ onRetry }: { onRetry?: () => void }): JSX.Element => {
  return (
    <ErrorCard
 ...
 */
export const NotFoundError = ({ resourceName }: { resourceName: string }): JSX.Element => {
  return (
    <EmptyState
      title="غير موجود"
...
/**
 * Default ErrorMessage component (same as ErrorCard)
 */
export const ErrorMessage = ({ message, onRetry, className = '' }: ErrorMessageProps): JSX.Element => {
  return (
    <div className={`bg-red-50 border-2 border-red-200 rounded-lg p-4 ${className}`}>
      <div className="flex items-start gap-3">
        <XCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
