...
export default function AddCreditsModal({ open, onClose }: AddCreditsModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md rounded-3xl" dir="rtl">
        <DialogHeader>
          <DialogTitle className="text-gray-900 arabic-text text-right">شحن الرصيد</DialogTitle>
        ...
        <div className="space-y-6">
          {/* Preset Amounts */}
          <div>
            <Label className="mb-3 block arabic-text text-right">اختر المبلغ</Label>
              ...
              {presetAmounts.map((amount) => (
                ...
                >
                  <div className="text-center">
                    <div>{amount}</div>
                    <div className="opacity-80">ريال</div>
                  </div>
                </Button>
              ))}
            </div>
          ...
          {/* Custom Amount */}
          <div>
            <Label htmlFor="custom-amount" className="mb-2 block arabic-text text-right">
              أو اكتب مبلغ
            </Label>
          ...
          {/* Payment Method */}
          <div>
            <Label className="mb-3 block arabic-text text-right">طريقة الدفع</Label>
          ...
          <div className="bg-blue-50 rounded-2xl p-4 border border-blue-100">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-900 arabic-text">{selectedAmount} ريال</span>
              <span className="text-gray-600 arabic-text text-right">المبلغ</span>
            </div>
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-900 arabic-text">0 ريال</span>
              <span className="text-gray-600 arabic-text text-right">رسوم المعالجة</span>
            </div>
            <div className="pt-2 border-t border-blue-200">
              <div className="flex items-center justify-between">
                <span className="text-blue-600 arabic-text">{selectedAmount} ريال</span>
                <span className="text-gray-900 arabic-text text-right">المجموع</span>
              </div>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            >
              <span className="arabic-text">ادفع</span>
            </Button>
            <Button
              variant="outline"
              onClick={onClose}
