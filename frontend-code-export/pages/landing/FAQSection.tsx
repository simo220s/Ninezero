...
const faqs = [
  {
    ...
    answer: 'نعم، الجلسة التجريبية مجانية تماماً ولا توجد أي رسوم خفية. هذه الجلسة مدتها 25 دقيقة مع الأستاذ أحمد لتقييم مستوى طفلك ووضع خطة تعليمية مناسبة له.'
  },
  {
    id: 2,
    question: 'ماذا لو لم يناسبني الوقت المحجوز؟',
    answer: 'لا مشكلة! يمكنك إعادة جدولة الحصة حتى 24 ساعة قبل الموعد المحدد. نحن نوفر مرونة كاملة في الجدولة لتناسب ظروفك وأوقاتك.'
  },
  {
    id: 3,
    question: 'كيف يتم الدفع؟',
    answer: 'نقبل جميع طرق الدفع المتاحة في السعودية: التحويل البنكي، مدى، فيزا، ماستركارد، وأبل باي. الدفع آمن ومحمي بأعلى معايير الأمان.'
  },
  {
    id: 4,
    question: 'هل توجد ضمانات؟',
    answer: 'نعم، نوفر ضمان استرجاع الأموال خلال 30 يوم إذا لم تكن راضياً عن الخدمة. كما نضمن تحسن مستوى طفلك خلال 3 أشهر أو نعيد لك أموالك.'
  },
  {
    id: 5,
    question: 'ما هي أعمار الطلاب المناسبة؟',
    answer: 'نتخصص في تعليم الأطفال من عمر 10 إلى 18 سنة. الأستاذ أحمد لديه خبرة واسعة في التعامل مع هذه الفئة العمرية وفهم احتياجاتهم التعليمية.'
  },
  {
    id: 6,
    question: 'كم عدد الحصص المطلوبة لرؤية النتائج؟',
    answer: 'عادة ما نرى تحسناً ملحوظاً خلال 4-6 حصص. للوصول للطلاقة الكاملة، نحتاج حوالي 500 ساعة تعليمية موزعة على 12-18 شهر حسب مستوى الطالب والتزامه.'
  }
]
        ...
        <Card className="bg-primary-50 border-primary-200">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-primary-600 arabic-text mb-6">
              تحدث مع الأستاذ أحمد مباشرة عبر واتساب. نحن متاحون 24/7 للإجابة على جميع استفساراتك
            </p>
            ...
            <div className="mt-6 flex items-center justify-center space-x-4 space-x-reverse text-sm text-primary-600">
              ...
              <div className="flex items-center space-x-2 space-x-reverse">
                ...
                <span className="arabic-text">رد خلال 5 دقائق</span>
              </div>
            </div>
          </CardContent>
        </Card>
