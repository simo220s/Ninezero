        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 arabic-text leading-relaxed text-sm">
              معلم لغة إنجليزية معتمد من جامعة أريزونا الأمريكية بشهادة TESOL. خبرة أكثر من 5 سنوات في تعليم الأطفال والمراهقين السعوديين من عمر 10-18 سنة.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                >
                  ...
                  <span className="arabic-text">info@example.com</span>
                </a>
              </li>
              <li>
                <a 
                ...
                >
                  ...
                  <span className="arabic-text">+966 50 000 0000</span>
                </a>
              </li>
            </ul>
          </div>
